...
void Menu()     //calculator functions and display
{
    ...
    printf("15. Matrix operations - 2x2\n");
    printf("16. Matrix operations - 3x3\n");
    printf("17. Quadratic Solver\n");
    printf("18. All Complex Functions\n");
    printf("19. All unit conversions\n");
    printf("20. Expression Evaluator\n");
    printf("0. Exit\n");
    printf("-------------------\n");
...
int main()
{
    ...
    int gd = DETECT, gm;        //declares graphics driver(gd) to detect the appropriate graphics driver and graphics mode(gm) holds the graphics mode the driver selects
    initgraph(&gd, &gm, "");    //initializes the graphics. " "shows the path of the graphics driver
    setbkcolor(BLACK);                  //to set the background colour
    cleardevice();                      //clears the graphic screen and fills it with the particular colour
    setcolor(YELLOW);                   //to set the buttons colour
    settextstyle(GOTHIC_FONT, HORIZ_DIR, 1);    //sets font style
    outtextxy(100, 85, "Welcome.Press any key to start!");
    calculator_graphic();               //calling the calculator graphics function
    getch();                            //clearing the buffer
    closegraph();                       //closing the calculator graphic
    int choice;
    double a, b;
    ...
    while (1)
        {   L2:
            ...
            Menu();     //to get the menu of the calculator
                    ...
                    switch (choice)
                        {
                            ...
                            default:                            //to exit the unit conversion menu
                                printf("Exiting......\n\n");
                                system("cls");
                                goto L2;
                        }
